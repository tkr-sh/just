...
impl Search {
    ...
    pub fn find(search_config: &SearchConfig, invocation_directory: &Path) -> SearchResult<Self> {
        match search_config {
    ...
    pub fn search_parent_directory(&self) -> SearchResult<Self> {
        let parent = self
            ...
            .ok_or_else(|| {
                SearchError::JustfileHadNoParent {
    ...
    pub fn init(search_config: &SearchConfig, invocation_directory: &Path) -> SearchResult<Self> {
        match search_config {
